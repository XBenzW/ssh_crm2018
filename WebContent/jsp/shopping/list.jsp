			...
			<TR>
				...
				<TD vAlign=top width="100%" bgColor=#ffffff>
					<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
						<TR>
							<TD class=manageHead>当前位置：消费记录管理 &gt; 消费记录列表</TD>
						</TR>
						<TR>
							<TD height=2></TD>
						</TR>
					...
					<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0 width="100%"
						...
						<TBODY>
							<TR>
								<TD height=25>
									<FORM id="pageForm" name="shoppingForm"
										action="${pageContext.request.contextPath }/ShoppingAction_list"
										method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
													...
													<TD>
													  ...
													  <INPUT class=textbox 
														style="WIDTH: 80px" maxLength=50 id="cust_name" name="customer.cust_name"
														value="${param['customer.cust_name'] }">
								...
								<TD>
									<TABLE id=grid
										...
										<TBODY>
											...
											<s:iterator value="#pageBean.list" var="shopping">
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD><s:property value="#shopping.shop_date" /></TD>
													<TD><s:property value="#shopping.customer.cust_name" /></TD>
													<TD><s:property value="#shopping.shop_project" /></TD>
													<TD><s:property value="#shopping.shop_product" /></TD>
													<TD><s:property value="#shopping.shop_price" /></TD>
													<s:if test="#shopping.shop_confirm==true">
													 <TD>是</TD>
													</s:if>
													<s:elseif test="#shopping.shop_confirm==false">
													<TD>否</TD>
													</s:elseif>
