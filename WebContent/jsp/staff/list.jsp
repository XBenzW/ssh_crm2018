			...
			<TR>
				...
				<TD vAlign=top width="100%" bgColor=#ffffff>
					<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
						<TR>
							<TD class=manageHead>当前位置：工作人员管理 &gt; 工作人员列表</TD>
						</TR>
						<TR>
							<TD height=2></TD>
						</TR>
					...
					<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0 width="100%"
						...
						<TBODY>
							<TR>
								<TD height=25>
									<FORM id="pageForm" name="staffForm"
										action="${pageContext.request.contextPath }/StaffAction_list"
										method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="staff_name"
														value="${param.staff_name }"></TD>
								...
								<TD>
									<TABLE id=grid
										...
										<TBODY>
											...
											<s:iterator value="#pageBean.list" var="staff">
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD><s:property value="#staff.staff_name" /></TD>
													<TD><s:property value="#staff.staff_gender" /></TD>
													<TD><s:property value="#staff.staff_born" /></TD>
													<TD><s:property value="#staff.staff_password" /></TD>
													<TD><s:property value="#staff.staff_phone" /></TD>
													<TD><s:property value="#staff.staff_mobile" /></TD>
													<TD><a
